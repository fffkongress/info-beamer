...
function node.render()
    ...
    jost:write(700, 150, shifts[1][2], 70,1,1,1,1)
    jost:write(1300, 150, "Dauer", 70,1,1,1,1)


    for i = 2, #shifts, 1 do
        jost:write(50, 150 + i * 50, shifts[i][4], 50,1,1,1,1)
        jost:write(150, 150 + i * 50, shifts[i][1], 50,1,1,1,1)
        jost:write(700, 150 + i * 50, shifts[i][2], 50,1,1,1,1)
        jost:write(1300, 150 + i * 50, shifts[i][3] .. " min", 50,1,1,1,1)
    end
end